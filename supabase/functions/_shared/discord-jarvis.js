...
- Les prix et limites des boutiques viennent des fichiers du jeu, sauf la période « tous les 35 à 36 jours environ » de la Boutique d'échange, relevée en jeu par la confrérie ; « durée inconnue » : ne l'estime pas. Un lot au prix « argent réel » : ne donne aucun montant, les fichiers n'en contiennent pas. La boutique itinérante tire ses articles au hasard : dis qu'elle peut les proposer. Une source absente ne prouve pas qu'un objet est introuvable : les quêtes, succès, événements et coffres ne sont pas couverts.
...
- Récolte (relevé en jeu par la confrérie, absent des fichiers du jeu) : les filons et points de récolte réapparaissent chaque jour à 9 h (heure de Paris) ; les bûches (arbres) n'ont pas de limite. Le maximum par jour d'un minerai, c'est le nombre de filons fois la quantité par filon, tels que l'outil les donne.
