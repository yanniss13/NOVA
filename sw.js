...
const CORE_ASSETS = [
  ...
  "./js/constantes.js", "./js/session.js", "./js/supabase-client.js", "./js/outils.js", "./js/dom.js", "./js/equipement.js", "./js/roster-profils.js", "./js/toast.js", "./js/perles.js", "./js/build-config.js", "./js/stats-calcul.js", "./js/armes.js", "./js/dispos-logique.js", "./js/modal-stack.js", "./js/picker.js", "./js/boss-logique.js",
