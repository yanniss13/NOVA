...
const CORE_ASSETS = [
  "./", "./index.html", "./css/charte.css", "./css/socle.css", "./css/composants.css", "./css/coquille.css", "./css/accueil.css", "./css/builder.css", "./css/roster.css", "./css/analyse.css", "./css/boss.css", "./css/suivi.css", "./css/modales.css", "./css/import-captures.css", "./css/notifications.css", "./css/responsive.css", "./css/dispos.css", "./css/wiki.css", "./css/collection.css", "./css/calculateur.css",
...
self.addEventListener("message", event => {
  if(event.data && event.data.type === "CACHE_BUILD_STATS"){
    const reply = success => {
      if(event.ports && event.ports[0]) event.ports[0].postMessage({success});
    };
    event.waitUntil(
      caches.open(CACHE)
        .then(cache => cache.match("./data/stats-build.js")
          .then(cached => cached || cache.add("./data/stats-build.js")))
