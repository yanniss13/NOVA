// Bilan de lisibilite d un export des tables du jeu.
//
...
//   le journal de l outil d export  ->  "Could not read DataTable correctly"
const fs = require('fs');
const path = require('path');
// Un argument permet de viser une extraction archivee, pour comparer deux usmap :
//   node outils/fabrication/bilan-tables.js .../Exports-usmap-1.7/SevenDeadlySins/Content/Table
const RACINE = process.argv[2] ||
  (process.env.DONNEES_JEU || '') + '/Table';
