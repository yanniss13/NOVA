/* Ecrit data/animations-verrous.json a partir de data/temps-action.json.
   ...
   Lancer : node outils/fabrication/ecrire-verrous.js
*/
const fs = require('fs');
...
const sortie = {
  _lisezmoi: [
    ...
    '',
    'Regenerer : node outils/fabrication/ecrire-verrous.js',
    '',
    "Un heros ajoute apres coup suit le build que data/temps-action.json",
    'note pour ses actions (fusionner.js --seulement=<heros>).',
  ],
  _unite: 'secondes',
  _build: '1.8.1.2',
  animations: verrous,
