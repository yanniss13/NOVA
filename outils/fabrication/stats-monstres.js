/* Les statistiques DEFENSIVES d'un monstre, par son nom francais.
   ...
   Lancer : node outils/fabrication/stats-monstres.js "lapin mutilateur rapide" "cache-cache"
            node outils/fabrication/stats-monstres.js --groupe stat_1234
*/
const fs = require('fs');
...
if (!Object.keys(monstres).length && !Object.keys(npc).length) {
  ...
  console.log('  le journal de l outil d export : « Could not read DataTable correctly »');
