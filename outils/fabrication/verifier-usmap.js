// Lit un .usmap et le compare a un autre, sans passer par l outil d export.
//
...
//
//   node outils/fabrication/verifier-usmap.js <fichier.usmap>
//   node outils/fabrication/verifier-usmap.js <nouveau.usmap> <ancien.usmap>
//
...
// pas le bloc final CEXT/PPTH que portent ceux d une autre provenance.
//
...
function analyser(chemin) {
  ...
  // Certains usmap ajoutent un bloc CEXT/PPTH (chemins de
...
if (!args.length) {
  console.log('usage : node outils/fabrication/verifier-usmap.js <fichier.usmap> [ancien.usmap]');
  process.exit(1);
}
