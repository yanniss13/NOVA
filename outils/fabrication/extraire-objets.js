...
function main() {
  ...
  const catalogue = construireCatalogueObjets({
    ...
    familiers:lignesDeTable("Item/PetDataInfo.json"),
    competencesFamiliers:lignesDeTable("Pet/PetSkillTable.json"),
    competences:lignesDeTable("Skill/SkillTable.json"),
    captures:lignesDeTable("Actor/CatchDataTable.json"),
    minage,
