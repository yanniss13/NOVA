/* Ecrit data/magie-rotation.js depuis PC_SkillTable.
   ...
   La source la plus recente sous DONNEES_JEU est choisie.
*/
"use strict";
...
function sourcesDisponibles(){
  const base = process.env.DONNEES_JEU_SOURCES
...
if(!sourcePath){
  throw new Error("PC_SkillTable.json introuvable sous " + base);
}
