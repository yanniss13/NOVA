/* Ecrit data/magie-rotation.js depuis PC_SkillTable.
   ...
   Lancer : node outils/fmodel/ecrire-magie-rotation.js
   La source la plus recente sous Downloads/FModel/Output est choisie.
*/
"use strict";
...
function sourcesDisponibles(){
  const base = path.join(os.homedir(), "Downloads", "FModel", "Output");
...
const sourcePath = sourcesDisponibles()[0];
if(!sourcePath){
  throw new Error("PC_SkillTable.json introuvable sous Downloads/FModel/Output");
}
