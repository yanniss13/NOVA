...
const SUITES = {
  unit: [
    ...
    "node tests/courbe-scores.test.js",
    "node tests/boss-serie-hebdo.test.js",
    ...
    "node tests/libelles-par-fichier.test.js",
    ...
    "node tests/gravees-client.test.js",
    ...
    "node tests/effets-monstres-jarvis.test.js",
    "node tests/objets-jarvis.test.js",
    "node tests/discord-jarvis-objets.test.js",
    ...
    "python scripts/generate-armures-liees.py --check",
  ...
  e2e: [
    ...
    "node tests/boss-progression.playwright.js",
