...
NON_INCLUS_SPECIFIQUES = {
    ...
    "skill:calla_gauntlets_skill_r": "debuff-cible-limite-aux-competences-normales-de-terre",
    "skill:calla_gauntlets_skill_q_1": "bombes-contact-ou-explosion-differee-hors-schema",
    "potential:khala:SwordDual:4": "bonus-limite-a-une-variante-conditionnelle",
    "potential:khala:SwordDual:5": "tics-periodiques-de-variante-et-debuff-cible-hors-schema",
    "potential:khala:SwordDual:7": "dernier-coup-de-variante-et-cumuls-conditionnels",
    "potential:khala:SwordDual:9": "bonus-composite-de-variante-conditionnelle",
    "potential:khala:SwordDual:10": "dernier-coup-de-variante-et-cumuls-conditionnels",
    "potential:khala:Cudgel3c:5": "projectiles-supplementaires-hors-schema",
    "potential:khala:Cudgel3c:6": "renfort-de-buff-equipe-conditionnel",
    "potential:khala:Cudgel3c:9": "bonus-equipe-conditionnel-au-bouclier",
    "potential:khala:Cudgel3c:10": "cumuls-equipe-et-attaque-elementaire-conditionnels",
    "potential:khala:Gauntlets:5": "bombes-contact-ou-explosion-differee-hors-schema",
    "potential:khala:Gauntlets:6": "bonus-equipe-conditionnel-au-deluge",
